      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map(({ icon, title, desc }, i) => (
            <div
              key={title}
              className="card-reveal glass-card-dark rounded-2xl p-6 lg:p-8 group hover:glass-card-warm-dark transition-all duration-500 hover:border-brand-500/30 hover:-translate-y-1 cursor-default"
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={label} className="text-center glass-card-dark rounded-2xl py-6 px-4 hover:glass-card-warm-dark transition-all duration-300">
